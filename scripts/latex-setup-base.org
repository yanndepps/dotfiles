...
#+LATEX_CLASS_OPTIONS: [article, 9pt]

#+LATEX_HEADER: \usepackage[T1]{fontenc}
#+LATEX_HEADER: \usepackage{tgadventor} % Ensures we have the right font
...
% Ensure use of our selected font through the whole document
#+LATEX_HEADER: \renewcommand{\familydefault}{qag}

% Title customization
#+LATEX_HEADER: \pretitle{\begin{center}\fontfamily{qag}\fontsize{20pt}{20pt}\selectfont}
#+LATEX_HEADER: \posttitle{\par\end{center}}
#+LATEX_HEADER: \preauthor{\begin{center}\vspace{-6bp}\fontfamily{qag}\fontsize{14pt}{14pt}\selectfont}
#+LATEX_HEADER: \postauthor{\par\end{center}\vspace{-25bp}}

#+LATEX_HEADER: \predate{\begin{center}\fontfamily{qag}\fontsize{12pt}{12pt}\selectfont}
...
#+LATEX_HEADER: \lstdefinestyle{mystyle}{backgroundcolor=\color{backcolour}, commentstyle=\color{codegreen}, keywordstyle=\color{magenta}, numberstyle=\tiny\color{codegray}, stringstyle=\color{codepurple}, basicstyle=\selectfont\footnotesize, breakatwhitespace=false, breaklines=true, captionpos=b, keepspaces=true, numbers=left, numbersep=5pt, showspaces=false, showstringspaces=false, showtabs=false, tabsize=2}
